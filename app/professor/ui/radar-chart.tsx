...
export function RadarChart({ stats }: RadarChartProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4 rounded-2xl border border-slate-800 bg-slate-950/60 p-6">
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} aria-label="Radar de atributos">
        ...
        <polygon points={points} fill="rgba(56, 189, 248, 0.2)" stroke="#38bdf8" strokeWidth="2" />
      </svg>
